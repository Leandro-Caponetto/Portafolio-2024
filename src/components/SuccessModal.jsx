  ...
  return (
    <div className="fixed z-10 inset-0 overflow-y-auto bg-black bg-opacity-80 flex justify-center items-center">
      <div className="bg-white border-2 border-green-500 rounded-lg overflow-hidden p-8 pt-4 pr-6 max-w-lg w-full mx-4">
        ...
        <h2 className="text-lg sm:text-2xl font-bold pr-6 mb-4 mt-4">{isEnglish ? 'Form submitted successfully' : 'Formulario enviado con éxito'}</h2>
        <p className="text-md sm:text-lg pr-8 text-gray-600">{isEnglish ? 'Thank you for contacting me, I will reply as soon as possible.' : 'Gracias por contactarme, te responderé lo antes posible.'}</p>
      </div>
    </div>
  );
};
